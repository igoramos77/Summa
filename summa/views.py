...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['total_atividades_aguardando_aprovacao'] = AtividadeComplementar.objects.filter(usuario=context['current_user'], status='em_validação').count()
        ...
        for teste in context['data_graph_months']:
            teste['date'] = datetime.strptime(teste['date'], '%m/%Y')
...
class AlterarSenhaView(PasswordChangeView):
    ...
    def get_context_data(self, **kwargs):
        context = super(AlterarSenhaView, self).get_context_data(**kwargs)
